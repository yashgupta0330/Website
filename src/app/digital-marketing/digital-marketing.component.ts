...
export class DigitalMarketingComponent implements OnInit {
  ...
  private tryScrollToCardFromSession(): void {
    ...
    try {
      ...
      if (source === '/solutions/digital-marketing') {
        cardId = cid;
      }
    } catch {}
    if (!cardId) return;
  ...
  onCaseStudyClick(cardId: string): void {
    ...
    this.scrollRestoration.saveScrollPosition('/solutions/digital-marketing');
    // Save navigation context for solution-aware back navigation
    sessionStorage.setItem(
      'solution_case_study_nav',
      JSON.stringify({ source: '/solutions/digital-marketing', cardId })
    );
  ...
  setMetaTags(): void {
    this.titleService.setTitle('Digital Marketing Company in Delhi | Best Digital Marketing Agency in Delhi - Anarish');

    this.metaService.updateTag({
      name: 'description',
      content: 'Boost your business with a top-rated Digital Marketing Company in Delhi. We offer SEO, social media marketing, PPC, and content strategies to help you grow online. Contact us today!'
    });

    this.metaService.updateTag({ property: 'og:url', content: 'https://www.anarish.com/services/digital-marketing' });
    this.metaService.updateTag({ property: 'og:type', content: 'website' });
    this.metaService.updateTag({ property: 'og:title', content: 'Digital Marketing Company in Delhi | Best Digital Marketing Agency in Delhi - Anarish' });
    this.metaService.updateTag({ property: 'og:description', content: 'Boost your business with a top-rated Digital Marketing Company in Delhi. We offer SEO, social media marketing, PPC, and content strategies to help you grow online. Contact us today!' });
    ...
    this.metaService.updateTag({ property: 'twitter:url', content: 'https://www.anarish.com/services/digital-marketing' });
    this.metaService.updateTag({ name: 'twitter:title', content: 'Digital Marketing Company in Delhi | Best Digital Marketing Agency in Delhi - Anarish' });
    this.metaService.updateTag({ name: 'twitter:description', content: 'Boost your business with a top-rated Digital Marketing Company in Delhi. We offer SEO, social media marketing, PPC, and content strategies to help you grow online. Contact us today!' });
  ...
  loadFaqs(): void {
    const faqFilePath = '/assets/data/solutions/digital-marketing.json';
