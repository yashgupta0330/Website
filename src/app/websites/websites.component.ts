...
export class WebsitesComponent implements OnInit {
  ...
  work_cards = ['remit', 'finc']; // Update IDs as per your actual portfolio
  portfolioData: any[] = [];
  ...
  onCaseStudyClick(cardId: string): void {
    ...
    this.scrollRestoration.saveScrollPosition('/solutions/websites');
    // Save navigation context for solution-aware back navigation
    sessionStorage.setItem(
      'solution_case_study_nav',
      JSON.stringify({ source: '/solutions/websites', cardId })
    );
  ...
  loadFaqs(): void {
    const faqFilePath = '/assets/data/solutions/websites.json';
